...
TelegramRouter.post("/send-post/:id",telegramController.campaignByBrandPersonal);
TelegramRouter.post("/campaign-brand-personal/:id",telegramController.campaignByBrandPersonal);
