...
Video_editing_router.post(
  "/split-content-stp",
  controllerSplitAndGenerate.splitAndConvertSTP
);
Video_editing_router.post("/test-audio", controllerRegenrateAudio.testAudio);
Video_editing_router.post(
  "/regenrate-audio",
  controllerRegenrateAudio.regenrateAudio
);
Video_editing_router.post(
  "/replace-words",
  controllerReplaceWords.addWordToReplace
);
Video_editing_router.post(
  "/find-replace",
  controllerReplaceWords.findToReplace
);
Video_editing_router.post("/enhance-img", controllerEnhanceImage.editImage);
Video_editing_router.post(
  "/process-video",
  controllerProcessOnVideo.processVideo
);
Video_editing_router.post(
  "/split-content-inv",
  controllerSplitAndGenerate.splitAndConvertINV
);
Video_editing_router.post("/search-youtube", fetchVideos.searchVideosOnYouTube);
Video_editing_router.post(
  "/search-youtube-cnbc",
  fetchVideos.searchVideosOnYouTubeCnbc
);
Video_editing_router.post("/trim-video", fetchVideos.trimVideo);
