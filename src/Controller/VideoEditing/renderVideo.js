...
const renderVideo = async (req, res) => {
  try {
    ...
    let slide1lDuration = slide1Json.reduce(
      (acc, slide1) => acc + (slide1.audioPath.duration || 15),
      0
    );
    let slide2lDuration = slide2Json.reduce(
      (acc, slide2) => acc + (slide2.audioPath.duration || 15),
      0
    );
    let slide3lDuration = slide3Json.reduce(
      (acc, slide3) => acc + (slide3.audioPath.duration || 15),
      0
    );
    let slide4lDuration = slide4Json.reduce(
      (acc, slide4) => acc + (slide4.audioPath.duration || 15),
      0
    );
    let totalDuration =
      bodyDuration +
    ...
    slide1Json.forEach((slide1, index) => {
      ...
      template.elements[1].elements[0].source = String(
        keywordsAndImages[0].imageUrl[0]
      );
    ...
    slide2Json.forEach((slide2, index) => {
      ...
      template.elements[2].elements[3].source = String(
        keywordsAndImages[0].imageUrl[0]
      );
    ...
    slide3Json.forEach((slide3, index) => {
      ...
      template.elements[3].elements[0].source = String(
        keywordsAndImages[0].imageUrl[0]
      );
      template.elements[3].elements[1].source = String(
        keywordsAndImages[0].imageUrl[0]
      );
    ...
    slide4Json.forEach((slide4, index) => {
      ...
      template.elements[4].elements[3].source = String(
        keywordsAndImages[0].imageUrl[0]
      );
