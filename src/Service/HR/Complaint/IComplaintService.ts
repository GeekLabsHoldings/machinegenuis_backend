...
export default interface IComplaintService {
    ...
    getOneComplaint(_id: string): Promise<IComplaintModel | null>;
    solveComplaint(_id: string): Promise<IComplaintModel | null>;
}